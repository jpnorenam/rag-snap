...
and reset them to the built-in defaults. The daemon owns a persisted store of overrides; a
prompt without an override always resolves to the built-in default of the running release. The
